...
sys.path.insert(0, os.path.abspath('../../bookstore'))


# -- Project information -----------------------------------------------------

project = 'bookstore'
copyright = '2018, nteract project'
...
htmlhelp_basename = 'bookstoredoc'
...
latex_documents = [
    (master_doc, 'bookstore.tex', 'bookstore Documentation', 'nteract project', 'manual')
]
...
man_pages = [(master_doc, 'bookstore', 'bookstore Documentation', [author], 1)]
